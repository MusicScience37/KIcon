...
magick convert -density 1000 KIcon.svg -resize 1024x1024 -transparent white PNG/KIcon1024.png
magick convert PNG/KIcon16.png PNG/KIcon24.png PNG/KIcon32.png PNG/KIcon48.png PNG/KIcon64.png PNG/KIcon152.png PNG/KIcon512.png PNG/KIcon1024.png -colors 256 KIcon.ico